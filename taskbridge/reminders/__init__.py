...
- ``remindercontainer.py`` - Contains the ``ReminderContainer`` class which represents a synced pair of list and calendar, and the ``LocalList``  and ``RemoteCalendar`` classes that represent a local reminder list and remote task calendar respectively.
